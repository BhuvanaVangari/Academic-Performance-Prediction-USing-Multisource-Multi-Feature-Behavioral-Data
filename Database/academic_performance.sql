...
--
CREATE DATABASE IF NOT EXISTS `academic_performance` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
('5p7d1g0o50vpw1el8zk6dnju8k8vzskm', 'ZWU1N2VmY2YxM2M4Nzg4YzA4NTk5YjZmZjllYWY5ODY3YzNiYTQ4NDp7InVzZXJpZCI6M30=', '2020-03-12 12:38:06.728515'),
...
('sf806k2bicwz5arc2z4ayolaagb6wy7o', 'YzgyMzJlMDQ0NjQyOWIwMzk5MDNiZDFjOTg1N2M3NTkyNmMyZDY2ZDp7InVzZXJpZCI6MTd9', '2020-02-24 12:12:56.128789'),
...
('vudo32ndop22siou7tl83nn0h0q6x7pt', 'eyJ1c2VyaWQiOjZ9:1krfRT:A5n-kwxTLrTPRmuEgdb4GTll_HU3uMmcN-e5pPWEOW4', '2021-01-05 11:02:59.081031');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_clientreadings_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_clientreadings_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(4, 'Saravanan', 'Sara.123@gmail.com', 'Saravanan', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(5, 'Ashok', 'Ashok.123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(6, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_studentdata_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_studentdata_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Physical_Fit` varchar(300) NOT NULL,
  `cardio_Fit` varchar(300) NOT NULL,
  `Aerobic_Fit` varchar(300) NOT NULL,
  `Stress` varchar(300) NOT NULL,
  `Mental_Health` varchar(300) NOT NULL,
  `Intelligent` varchar(300) NOT NULL,
  `Executive_fun` varchar(300) NOT NULL,
  `Eating` varchar(300) NOT NULL,
  `Pyhsical_Activity` varchar(300) NOT NULL,
  `Sleep_pattern` varchar(300) NOT NULL,
  `Social_Tie` varchar(300) NOT NULL,
  `Time_Management` varchar(300) NOT NULL,
  `Stu_Class` varchar(300) NOT NULL,
  `Library_Entry` varchar(300) NOT NULL,
  `Online_learning` varchar(300) NOT NULL,
